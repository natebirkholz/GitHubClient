...
//    var managedObjectContext = NSManagedObjectContext()
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if let value: AnyObject = NSUserDefaults.standardUserDefaults().valueForKey(key) {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "natebirkholz.GitHubClient" in the application's documents Application Support directory.
